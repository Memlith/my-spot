                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://i.postimg.cc/xjHYC8J1/Ex-Mapa2.png"
                                        alt="myspot"
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <div class="flex size-12 shrink-0 items-center justify-center rounded-[10px] bg-myspot-blue/10 sm:size-16">
                                            <img class="size-7 sm:size-8" src="https://i.postimg.cc/NfzgngDw/P.png" alt="">
                                        </div>
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                O Mapa de Vagas é uma ferramenta que permite visualizar as vagas disponíveis em tempo real, facilitando a busca por um local para estacionar.
                                                Com ele, você pode encontrar rapidamente uma vaga próxima ao seu destino, economizando tempo e evitando o estresse de procurar por estacionamento.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-[10px] bg-myspot-blue/10 sm:size-16">
                                    <img class="size-7 sm:size-8" src="https://i.postimg.cc/fWYdd18j/New-Project.png" alt="">
                                </div>
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                       Com MySpot, as empresas podem gerenciar suas vagas de estacionamento de forma eficiente e prática, além de permitir o controle do uso das vagas pelos funcionários.
                                    </p>
                                </div>

                                <svg class="size-6 shrink-0 self-center stroke-myspot-blue" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/></svg>
                            </a>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-[10px] bg-myspot-blue/10 sm:size-16">
                                    <img class="size-7 sm:size-8" src="https://i.postimg.cc/4KxFfDzF/medal.png" alt="">
                                </div>
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    <p class="mt-4 text-sm/relaxed">
                                        O MySpot oferece um sistema de assinatura que permite aos usuários reservar vagas de estacionamento com antecedência, garantindo um espaço garantido quando necessário.
                                        Isso é especialmente útil para aqueles que precisam estacionar em locais movimentados ou em horários de pico.
                                    </p>
                                </div>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-myspot-blue lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-myspot-blue">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-[10px] bg-myspot-blue/10 sm:size-16">
                                    <img class="size-7 sm:size-8" src="https://i.postimg.cc/MnDF86jQ/ambient.png" alt="">
                                        <g fill="#FF2D20">
                                            <path
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Preservando o Meio-Ambiente</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        O MySpot é uma plataforma que visa reduzir o impacto ambiental causado pelo tráfego de veículos, promovendo a utilização consciente dos espaços de estacionamento.
                                        Ao facilitar o compartilhamento de vagas, contribuímos para a diminuição da emissão de poluentes e do consumo de recursos naturais.
                                    </p>
                                </div>
                            </div>
                        </div>
